package com.jcs.common.result;

import com.jcs.common.constant.ResultConstant;
import lombok.Data;
...
public class CommonResult implements Serializable {
     ...
     * @return
     */
    public static CommonResult LoginOverTime(){
     return new CommonResult(ResultConstant.LONG_OVER_TIME,ResultConstant.LONG_OVER_TIME_MSG);
    }
